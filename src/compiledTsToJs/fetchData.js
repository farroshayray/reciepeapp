    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, fetch("https://www.themealdb.com/api/json/v1/1/search.php?s=".concat(query))];
                case 1:
                    response = _a.sent();
                    if (!response.ok) {
                ...
                case 2:
                    data = _a.sent();
                    displayFunction_1.default.displayData(data);
                    console.log(data);
                    return [3 /*break*/, 4];
                case 3:
                    error_1 = _a.sent();
                    console.error('Error:', error_1);
                    displayFunction_1.default.displayData({ meals: null });
                    return [3 /*break*/, 4];
...
function getData(execute) {
    return __awaiter(this, void 0, void 0, function () {
        var response, dataMeal, meal, error_2;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    dataMeal = _b.sent();
                    meal = (_a = dataMeal.meals) === null || _a === void 0 ? void 0 : _a[0];
...
exports.default = { fetchDataSearch: fetchDataSearch, getData: getData };
